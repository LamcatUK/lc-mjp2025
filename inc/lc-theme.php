...
function widgets_init() {
    ...
    register_nav_menus(
        array(
            'primary_nav'  => __( 'Primary Nav', 'lc-mjp2025' ),
            'footer_menu1' => __( 'Footer Nav 1', 'lc-mjp2025' ),
            'footer_menu2' => __( 'Footer Nav 2', 'lc-mjp2025' ),
        )
    );
...
/**
 * Allow ACF field groups to appear on descendants of a specific parent page.
 * Replace 123 with the ID of your target parent page.
 */
// add_filter(
//     'acf/location/rule_match/page_parent',
//     function ( $match, $rule, $options ) {

//         // Only run if the rule is for our parent page ID.
//         $target_parent_id = get_page_by_path( 'services' )->ID;
...
//         if ( (int) $rule['value'] !== $target_parent_id ) {
//             return $match;
//         }
...
//         // Check if this page is a descendant of the target parent.
...
//         $is_descendant = in_array( $target_parent_id, $ancestors, true );

//         // Match logic based on rule operator.
//         if ( '==' === $rule['operator'] ) {
