...
<head>
    ...
    <link rel="preload"
        href="<?= esc_url( get_stylesheet_directory_uri() . '/fonts/work-sans-v24-latin-600.woff2' ); ?>"
        as="font" type="font/woff2" crossorigin="anonymous">
    <link rel="preload"
        href="<?= esc_url( get_stylesheet_directory_uri() . '/fonts/lato-v25-latin-300.woff2' ); ?>"
        as="font" type="font/woff2" crossorigin="anonymous">
    <?php
...
<body <?php body_class( is_front_page() ? 'homepage' : '' ); ?>
    ...
    $header_class = ! is_front_page() ? 'has-primary-900-background-color' : '';
	?>
<header id="wrapper-navbar" class="fixed-top p-0 <?= esc_attr( $header_class ); ?>" itemscope
    itemtype="http://schema.org/WebSite">
	<nav class="navbar navbar-expand-lg">
		<div class="container gap-4">
            <div class="d-flex justify-content-between w-100 w-lg-auto align-items-center py-1 py-lg-0">
                <div class="logo-container d-flex align-items-center"><a href="/" class="logo navbar-brand" aria-label="MJP Electrical Contractors Homepage"></a></div>
